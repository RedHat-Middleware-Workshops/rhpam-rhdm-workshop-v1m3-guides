...
![Business Central CC Dispute Processing]({% image_path business-central-cc-dispute-processing.png %}){:width="600px"}
...
![Business Central CC Dispute Processing Backoffice Processing]({% image_path business-central-cc-dispute-processing-backoffice-processing.png %}){:width="600px"}
...
![Business Central CC Dispute Processing Automated Chargeback]({% image_path business-central-cc-dispute-processing-automated-chargeback.png %}){:width="600px"}

The second use case has the decisions to determine the risk of the transaction and if a manual approval is required.

![Business Central CC Dispute Processing Manual Standard Processing]({% image_path business-central-cc-dispute-processing-manual-standard-processing.png %}){:width="600px"}
